...
index 0000000000000000000000000000000000000000..9dbfecbde7ce1ba998eef753b7a19360430c3b6c
--- /dev/null
+++ b/storage.py
@@ -0,0 +1,90 @@
+import json
...
+
+class Storage:
+    def __init__(self, db_path: str, admin_id: int, categories: Dict[str, str]):
...
+            result["current_month_stats"] = {cat: 0 for cat in self.categories.keys()}
